package com.bizleap.training.assignment.monthprettyprint;
...
public class MonthMapGenerator1 {
	 ...
	 * List<Month> monthList = new ArrayList<Month>(); for (int year = fromYear;
	 * year <= toYear; year++) { monthList.addAll(createMonthsForYear(year)); }
	 * return monthList; }
	 * 
	 * public Map<Integer, Object> createMonthMapRange(int fromYear, int toYear) {
	 * if (isValid(fromYear, toYear)) { for (Month month :
	 * createMonthsForYearRange(fromYear, toYear)) { addMonthToMap(month); } } else
	 * { monthMap.put(fromYear, "Range or years are invalid"); monthMap.put(toYear,
	 * "Range or years are invalid"); } return monthMap; }
	 */
	...
	public static void main(String[] args) {
		...
		MonthMapGenerator1 monthMapGenerator = new MonthMapGenerator1();
		monthMapGenerator.createMonthMap(2001, 2003);
